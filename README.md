...
### Machine Learning & AI
- [diary-rag](https://github.com/phnx/diary-rag) - Revisiting my Smithsonian blog posts using open-source lightweight RAG and LLM (LangChain, Chroma, Ollama), with [explanation](https://github.com/phnx/diary-rag/tree/main/benchmark).
